...
import com.aapbd.mediaplayeraudio.ui.main.MainActivity;
...
public class PlaybackService extends Service implements IPlayback, IPlayback.Callback {
    ...
    private static final String ACTION_PLAY_TOGGLE = "com.aapbd.mediaplayeraudio.ACTION.PLAY_TOGGLE";
    private static final String ACTION_PLAY_LAST = "com.aapbd.mediaplayeraudio.ACTION.PLAY_LAST";
    private static final String ACTION_PLAY_NEXT = "com.aapbd.mediaplayeraudio.ACTION.PLAY_NEXT";
    private static final String ACTION_STOP_SERVICE = "com.aapbd.mediaplayeraudio.ACTION.STOP_SERVICE";

    private static final int NOTIFICATION_ID = 1;

    private RemoteViews mContentViewBig, mContentViewSmall;

    private com.aapbd.mediaplayeraudio.player.Player mPlayer;
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        if (intent != null) {
            ...
            if (ACTION_PLAY_TOGGLE.equals(action)) {
                ...
                // commented by biplob, enabling this line will close the service when you close the notification after pressing on close icon.
    ...
    @Override
    public void setPlayMode(com.aapbd.mediaplayeraudio.player.PlayMode playMode) {
