...
public class Player implements IPlayback, MediaPlayer.OnCompletionListener {
    ...
    public boolean playLast() {
        ...
        if (hasLast) {
            ...
            //play(); //it was a bug and below code is to play all song from playlist
    ...
    public void onCompletion(MediaPlayer mp) {
        ...
        if (mPlayList.getPlayMode() == com.aapbd.mediaplayeraudio.player.PlayMode.LIST && mPlayList.getPlayingIndex() == mPlayList.getNumOfSongs() - 1) {
            // In the end of the list
            // Do nothing, just deliver the callback
        } else if (mPlayList.getPlayMode() == com.aapbd.mediaplayeraudio.player.PlayMode.SINGLE) {
